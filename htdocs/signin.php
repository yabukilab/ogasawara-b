...
=======
    ...
    <form action="" method="POST">
        <!-- User registration fields -->
        <table>
            <tr><td><label for="username">ユーザ名</label></td><td><input type="text" name="username" id="username" required></td></tr>
            <tr><td><label for="password">パスワード</label></td><td><input type="password" name="password" id="password" required></td></tr>
            <tr><td><label for="faculty">学部</label></td><td><select class='mainselect' name="faculty" id="faculty" required>
>>>>>>> 6b38bec267eca09d6d5fa2c03019e981d8e108ef
...
=======
                <option value='shakai'>社会システム科学部</option></td></tr></select>
        

        <!-- 学科のセレクトボックス -->
        <div id="subbox-container">
        <tr><td><label for="department">学科</label></td><td><select name="department" id='department' class="subbox" required>
                <option value=''>学科を選択</option></td></tr></select>
        </div>
        </table>
>>>>>>> 6b38bec267eca09d6d5fa2c03019e981d8e108ef
